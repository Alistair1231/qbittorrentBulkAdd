...
if __name__ == '__main__':
    ...
    for torrent_file in torrent_files:
        ...
        save_path = input(f'Enter save path for {torrent_file.name} (Default is current clipboard contents: {clipboard_contents}): ') or clipboard_contents
        save_paths.append(save_path)

    # ask for category and defaulkt to "myanonamouse"
